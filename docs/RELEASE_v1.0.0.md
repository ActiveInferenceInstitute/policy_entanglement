...
| Git tag | `v1.0.0` |
| Zenodo record | https://zenodo.org/records/20419431 |
| DOI | https://doi.org/10.5281/zenodo.20419431 |
...
- [x] Flip canonical repository URL across `manuscript/config.yaml`, `CITATION.cff`,
  ...
  bibliography entry.
- [x] Mint production Zenodo DOI `10.5281/zenodo.20419431` (deposit includes combined PDF).
...
- [x] Re-render combined PDF with live AII repository URL and DOI `10.5281/zenodo.20419431`.
