...
[`docs/manuscript/refs/labels.yaml`](refs/labels.yaml) are the wiring; the
...
1. `docs/manuscript/refs/labels.yaml` declares the theorem registry with
...
1. The theorem row in `docs/manuscript/refs/labels.yaml` names the live Lean
   declaration.
