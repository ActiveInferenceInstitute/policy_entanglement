...
| [`float_real_residual_witness.md`](float_real_residual_witness.md) | Float↔ℝ residual scaffold (roadmap row) | [`FloatRealResidualWitness`](../../lean/ActinfPolicyEntanglement/FloatRealResidualWitness.lean) | (roadmap row — residual fields sourced from `output/reports/float_real_residual.json`; residual tracking in [`tests/test_meta_files_and_float_residual.py`](../../tests/test_meta_files_and_float_residual.py)) |
