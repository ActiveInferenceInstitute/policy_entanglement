...
from dashboard_types.payload import DashboardPayload, build_dashboard_payload as _build_dashboard_payload
...
def build_dashboard(args: argparse.Namespace, payload: DashboardPayload | dict[str, Any]) -> Any:
    from dashboard_types.panels import build_dashboard as _build_dashboard

    return _build_dashboard(args, payload)
