...
# Deprecated Round-11 guard names (values now canonical; kept for import compatibility).
LEGACY_PUBLICATION_DOI = CANONICAL_PUBLICATION_DOI
LEGACY_ZENODO_RECORD = CANONICAL_ZENODO_RECORD
LEGACY_SOURCE_REPOSITORY = CANONICAL_SOURCE_REPOSITORY

# Backward-compatible aliases (pre-Round-11 guard names).
UNRESOLVED_PUBLICATION_DOI = LEGACY_PUBLICATION_DOI
UNRESOLVED_ZENODO_RECORD = LEGACY_ZENODO_RECORD
UNRESOLVED_SOURCE_REPOSITORY = LEGACY_SOURCE_REPOSITORY
...
__all__ = [
    ...
    "DOI_PENDING_PHRASES",
    "DOI_REQUIRED_PATHS",
    "LEGACY_PUBLICATION_DOI",
    "LEGACY_SOURCE_REPOSITORY",
    "LEGACY_ZENODO_RECORD",
